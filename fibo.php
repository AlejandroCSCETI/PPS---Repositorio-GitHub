...
/*En primer lugar, lo primero que se va a hacer es el asegurarnos de que el 
número elegido es uno valido, por eso hemos puesto un "if" para hacer que 
si es menor de 0 ponga un mensaje de "Ese número no es valido"*/
    
    if ($n < 0){
       echo PHP_EOL;
       echo "Ese número no es valido";
      return;
   }
...
/* Despues, tenemos un foreach que vaya enseñando todos los datos que ha añadido al 
array para que se vea uno por uno hasta el final*/
